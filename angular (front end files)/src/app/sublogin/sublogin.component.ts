 ...
 //imported from regservice 
   ...
   loginUser2(){
     ...
     this._service.loginUserFromRemote1(this.subscriber).subscribe(
       ...
       console.log("response recieved",data.userName,data.emailId,data.mobileNum,data.typeOfSubscriber);  
       //user name display28th 
       this._service.temp1=data.userName;
       this._service.tempemailId=data.emailId;
       this._service.tempmobileNum=data.mobileNum;
       this._service.temptypeOfSubscriber=data.typeOfSubscriber;
       

       //user name display28th   temptypeOfSubscriber
