...
export class UserloginComponent implements OnInit {
  ...
  constructor(private _router : Router,private _service : RegistrationService,private _ser1:RegistrationService) { 
    ...
    this.b=this._ser1.tempemailId;
    this.c=this._ser1.tempmobileNum;
    this.d=this._ser1.temptypeOfSubscriber;
    console.log("name"+this._ser1.temp1);
    console.log("mail"+this._ser1.tempemailId);
    console.log("type"+this._ser1.temptypeOfSubscriber);
  }
